...
class Assertion extends TestResultReporter {
  ...
  isEmpty(value) {
    const setValueWhenUndefined = value || this._actual
    const isUndefined = typeof value === undefined || this._actual === undefined;

    const resultIsSuccessful = Utils.numberOfElements(setValueWhenUndefined || {}) === 0  && !isUndefined;
