...
function hasMethodDefined(actual, criteria) {
  return typeof actual[criteria] === 'function';
}
...
const CustomPropertyName = {
  ...
  evaluate: function(actual, expected, criteria) {
  ...
  _comparisonCanBeMade: (actual, expected, criteria) =>
    hasMethodDefined(actual, criteria) && hasMethodDefined(expected, criteria),
...
const ObjectWithEqualsProperty = {
  ...
  appliesTo: actual =>
    hasMethodDefined(actual, 'equals'),
...
const ObjectWithCyclicReference = {
  ...
  appliesTo: (actual, expected) =>
    isCyclic(actual) || isCyclic(expected),
