...
class RunTests extends ScriptAction {
  ...
  #isParsingParametersError(error) {
    return error instanceof InvalidConfigurationParameterError
      || error instanceof InvalidConfigurationParametersOrderError
  ...
  #handleExecutionError(error) {
    ...
    if (this.#isParsingParametersError(error)) {
