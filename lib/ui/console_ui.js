...
import { FormatterFactory } from './formatter_factory.js';
...
export class ConsoleUI {
  ...
  constructor(process, console) {
    ...
    this.#useFormatter(I18n.defaultLanguage(), 'console');
  }

  // configuration

  configureWith(configuration) {
    this.#useFormatter(configuration.language(), configuration.output());
  }
