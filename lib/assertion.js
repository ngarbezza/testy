...
class Assertion extends TestResultReporter {
  ...
  isTrue() {
    this._reportAssertionResult(this._actual === true, this.translated('be_true'));
  }
  
  isFalse() {
    this._reportAssertionResult(this._actual === false, this.translated('be_false'));
  }
  
  // Undefined value assertions
  
  isUndefined() {
    this._reportAssertionResult(isUndefined(this._actual), this.translated('be_undefined'));
  }
  
  isNotUndefined() {
    this._reportAssertionResult(!isUndefined(this._actual), this.translated('be_defined'));
  }
  
  // Null value assertions
  
  isNull() {
    this._reportAssertionResult(this._actual === null, this.translated('be_null'));
  }
  
  isNotNull() {
    this._reportAssertionResult(this._actual !== null, this.translated('be_not_null'));
  }
