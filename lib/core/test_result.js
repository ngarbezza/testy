...
import { detectUserCallingLocation, subclassResponsibility } from '../utils/index.js';
...
export class TestWithDefinition extends TestResult {
  #location;
...
class TestExplicitlyMarkedPending extends TestWithDefinition {
  ...
  resultAsText() {
    return I18nMessage.of('test_explicitly_marked_pending_result_message');
  }
}
...
class TestErrored extends TestWithDefinition {
  ...
  resultAsText() {
    return I18nMessage.of('test_errored_result_message');
  }
}
...
class TestSucceeded extends TestWithDefinition {
  ...
  resultAsText() {
    return I18nMessage.of('test_succeeded_result_message');
  }
}
...
class TestFailed extends TestWithDefinition {
  ...
  resultAsText() {
    return I18nMessage.of('test_failed_result_message');
  }
}
