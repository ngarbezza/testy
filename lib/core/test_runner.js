...
const { FailFast } = require('../config/fail_fast');
const { shuffle } = require('../utils');

/**
 * I am responsible for executing [test suites]{@link TestSuite}, collecting the results of each test of each suite
 * and report the aggregated results using a callback-based mechanism.
 */
class TestRunner {
