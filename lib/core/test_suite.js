...
export class TestSuite {
  ...
  static invalidSuiteFilePathErrorMessage() {
    return 'Suite does not have a valid file path. Please enter a valid file path string for this suite.'
  }
  ...
  #initializeLocation(pathLocation) {
    this.#ensureFilePathIsValid(pathLocation);
    ...
    if (!isStringWithContent(filePath)) {
      throw new Error(TestSuite.invalidSuiteFilePathErrorMessage());
    }
  }
