...
class Asserter extends TestResultReporter {
   ...
   * This is a shortcut of the {@link that} syntax followed by a [isNull]{@link Assertion#isNull} assertion.
   *
   * @example
   * assert.isNull(null)
   *
   ...
   * This is a shortcut of the {@link that} syntax followed by a [isNotNull]{@link Assertion#isNotNull} assertion.
   *
   * @example
